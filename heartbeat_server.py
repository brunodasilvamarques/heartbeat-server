...
def dashboard():
    ...
    <body>
        <img src="https://github.com/brunodasilvamarques/changebox-heartbeat-server/blob/main/assets/Changebox_Logo.jpg?raw=true" height="50" style="margin-bottom:10px;">
