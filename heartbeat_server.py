...
def download_csv_timestamps():
    ...
    for file in timestamp_files:
        with open(file, "r") as f:
            data = json.load(f)
            for date_key, blocks in data.items():
                ...
                for type_name in ["general", "restricted", "left", "right"]:
                    ...
                    combined_timestamps[date_key][type_name].extend(blocks.get(type_name, []))
    ...
    try:
        with open(output_csv, "w", newline="") as csvfile:
            ...
            for date_key, type_blocks in combined_timestamps.items():
                for type_name in ["general", "restricted", "left", "right"]:
