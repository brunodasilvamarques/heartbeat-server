...
def download_csv_face():
    ...
    try:
        ...
        with open(temp_csv, "w", newline="") as csvfile:
            ...
            if os.path.exists("kiosks_data.json"):
                with open("kiosks_data.json", "r") as f:
                    kiosk_metadata = json.load(f)
            else:
                kiosk_metadata = {}
            ...
            for day, kiosks_on_date in data.items():
                for kiosk_id, counts in kiosks_on_date.items():
                    ...
                    kiosk_name = kiosk_metadata.get(kiosk_id, {}).get("kiosk_name", "Unknown Kiosk")
