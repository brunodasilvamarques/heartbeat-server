...
def dashboard():
    ...
    <body>
        <img src="https://raw.githubusercontent.com/brunodasilvamarques/changebox-heartbeat-server/main/assets/Changebox_Logo.jpg" height="50" style="margin-bottom:10px;">
