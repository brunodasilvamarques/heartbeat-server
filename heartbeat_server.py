    ...
    for country, group in sorted(grouped.items()):
        ...
        for kiosk_id, data in sorted(group):
            ...
            """.format(
                ...
                actions=(
                    "<form method='post' action='/delete/{}' onsubmit='return verifyDelete(\"{}\")'><button type='submit'>Delete</button></form>".format(kiosk_id, kiosk_id)
        ...
        <div style="text-align:center; margin-bottom: 20px;">
            ...
            <div style="text-align:right; margin-top: -30px; margin-bottom:10px;">
                <form method="GET" action="/download_csv_footfall" style="display:inline-block; margin-right:10px;">
                    <button type="submit">Download CSV (Footfall)</button>
                </form>
                <form method="GET" action="/download_csv_face" style="display:inline-block;">
                    <button type="submit">Download CSV (Face Detection)</button>
                </form>
            </div>
        </div>
    """ + html_rows + """
