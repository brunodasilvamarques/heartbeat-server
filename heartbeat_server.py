...
def heartbeat():
    ...
    if kiosk_id:
        ...
        try:
            timestamp_file = "user_count_timestamps.json"
...
def download_csv():
    ...
    temp_csv = f"Changebox_Kiosk_UserCount_{country}_ALL_DATES.csv"
...
def download_csv_timestamps():
    timestamps_file = "user_count_timestamps.json"
    output_csv = "FaceDetection_Timestamps_Combined.csv"
    ...
    try:
        ...
        has_data = any(
            any(day_data.get(key) for key in ['general', 'restricted', 'left', 'right'])
        ...
        with open(output_csv, "w", newline="") as csvfile:
            ...
            for date_str, type_blocks in data.items():
